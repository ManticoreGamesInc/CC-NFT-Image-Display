...
Interested in contributing to CC-NFT-Image-Display? Want to report a bug?
...
[2]: https://github.com/ManticoreGamesInc/CC-NFT-Image-Display
...
3. **Pull Request**: After making sure everything passes, commit your changes,
   push your branch to GitHub and send a PR to `ManticoreGamesInc/CC-NFT-Image-Display:main`.
