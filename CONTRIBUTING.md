...
[2]: https://github.com/ManticoreGamesInc/Bootcamp-NFT-Image-Display
...
3. **Pull Request**: After making sure everything passes, commit your changes,
   push your branch to GitHub and send a PR to `ManticoreGamesInc/Bootcamp-NFT-Image-Display:main`.
